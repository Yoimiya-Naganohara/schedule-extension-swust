...
const SECTION_TIME = { 1: "08:00", 2: "08:50", 3: "10:00", 4: "10:50", 5: "14:00", 6: "14:50", 7: "16:00", 8: "16:50", 9: "19:00", 10: "19:50" };
...
async function fetchExpCourse(ctx, log) {
    ...
    do {
        ...
        for (const tr of html.matchAll(/<tr[^>]*>([\s\S]*?)<\/tr>/gi)) {
            ...
            events.push({ id: `exp-${week}-${day}-${start}`, title: name, day, start: SECTION_TIME[start] || "08:00", end: SECTION_TIME[end] || "09:40", location: loc, teacher, weeks: [week] });
        }
        page++;
